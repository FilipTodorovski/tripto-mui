...
const carouseImages = [
  '/assets/images/tecnico/1.png',
  '/assets/images/tecnico/2.png',
  '/assets/images/tecnico/3.png',
  '/assets/images/tecnico/4.png',
  '/assets/images/tecnico/5.png',
]
...
export { items, carouseImages, description, faq }
